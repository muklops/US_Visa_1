...
from US_Visa_1.constants import APP_HOST, APP_PORT
from US_Visa_1.pipline.prediction_pipeline import USvisaData, USvisaClassifier
from US_Visa_1.pipline.training_pipeline import TrainPipeline
